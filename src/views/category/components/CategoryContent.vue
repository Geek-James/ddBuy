  ...
  <div class="categoryContent">
    ...
    <div class="content">
      <div class="contentTitle"
           v-for="(productsItem,index) in detailContentData"
           :key="productsItem.id">
        <span class="title">{{productsItem.name}}</span>
        ...
        <li class="detailContent"
            v-for="(product,index) in productsItem.products"
            :key="product.id">
          <div class="detailImg">
          ...
          <div class="detailMessage">
            <p class="detailTitle">{{product.name}}</p>
            <p class="detailSubTitle">{{product.spec}}</p>
  ...
  methods: {
    ...
    _productItemScroll () {
      if (!this.contentScroll) {
        ...
        this.this.contentScroll.refresh();
      }
