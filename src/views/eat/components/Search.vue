...
<template>
  <div id="search">
    <div class="searchBox"
      ...
      <!--<span class="searchPrompt">{{ $t('messages.pleaseHolder') }}</span>-->
      <span class="searchPrompt">{{ messages.eat.pleaseHolder }}</span>
    ...
    <div class="todayMenu">{{ messages.eat.menu }}</div>
  </div>
</template>
...
export default {
  data () {
    return {
     messages: this.$i18n.messages[this.$i18n.locale]
    }
  },
  components: {
